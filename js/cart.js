...
const acumularTotal = () => {
    ...
    const cantidadTotalDelCarro = document.getElementById("precioTotal").innerHTML = `El Total es = $${total}`
}
acumularTotal()
...
function finalizarCompra() {
    swal({
        ...
        text: "Una vez que presiones OK finalizaras la compra. \n Se te Direccionará al sitio de pago seleccionado.",
        icon: "warning",
        buttons: true,
        dangerMode: true,
    })
        .then((sicompra) => {
            if (sicompra) {
                ...
                cardCarrito(storageCart),
                    ...
                    swal(`MUCHAS GRACIAS!!!\n tu compra ha finalizado en breve recibiras un mail \n Vuelve cuando quieras!!! ;)`, {
                        icon: "success",
                    });
            } else {
